...
const shopName = process.env.SHOPNAME_SHOPFLSINDIA;
const shopifyAccessToken = process.env.SHOPIFY_ADMIN_ACCESS_TOKEN_SHOPFLSINDIA;
const spreadsheetId = process.env.SPREADSHEETID_SHOPFLSINDIA;
